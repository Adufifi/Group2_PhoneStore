...
namespace PhoneStore.Api.Controllers
{
    ...
    public class ReviewController : ControllerBase
    {
        ...
        // Thêm một đánh giá mới với AccountId và ProductId
        ...
        public async Task<IActionResult> CreateReview([FromBody] ReviewDto reviewDto)
        {
            ...
            // Kiểm tra ProductId và AccountId có tồn tại trong hệ thống không (tuỳ theo logic của bạn)
        ...
        // Cập nhật đánh giá theo Id, kèm theo AccountId và ProductId
        ...
        public async Task<IActionResult> UpdateReview(Guid id, [FromBody] ReviewDto reviewDto)
        {
            ...
            // Kiểm tra nếu AccountId và ProductId của người dùng trùng khớp với dữ liệu trong review
        ...
        // Xóa đánh giá theo Id, kèm theo AccountId và ProductId
        ...
        public async Task<IActionResult> DeleteReview(Guid id, [FromQuery] Guid accountId, [FromQuery] Guid productId)
        {
            ...
            // Kiểm tra nếu AccountId và ProductId khớp với dữ liệu trong review
